...
k = 0
aice = np.zeros([4392, 288, 320])
for i in range(1, 367, 1):
    for j in range(1, 13, 1):
        data = xr.open_dataset("/home/b08209006/IONTU/SIC/yht_GTJRA_QVOLa/GTJRA_QVOLa.cice.h.0%.3d-%.2d.nc" % (i, j))
...
f_w = nc.Dataset('aice.nc', 'w', format='NETCDF4')
f_w.createDimension('time', 4392)
